	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				/* loginDataBaseAdapter.insertAdminEntry("Jayesh", "Hiray", "NCP", "Watch");
				 List<String>  list=loginDataBaseAdapter.getAllFirstName();*/
				...
				else
				{
				   ...
				   // reg_btn.setVisibility(View.GONE);
				    ...
				    Intent i=new Intent(Registration.this,LoginAndRegistrion.class);
				   	startActivity(i);
        ...
        cancel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent ii=new Intent(Registration.this,LoginAndRegistrion.class);
				startActivity(ii);
			}
		});
